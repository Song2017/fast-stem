...
function generate_swagger_lib() {
  ...
  gen_cmd="$gen_cmd -p groupId=group_id -p invokerPackage=$pkg_path"
...
" > $output/src/tests/java/$pkg_test_path/api/ShipApiWithAppCodeTest.java
