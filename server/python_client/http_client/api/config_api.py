...
from http_client.api_client import ApiClient, Endpoint as _Endpoint
from http_client.model_utils import (  # noqa: F401
...
class ConfigApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_config_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/config/connector/{id}',
    ...
    def get_config(
        ...
        **kwargs
        ...
        Get connector config.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_config(id, connector, async_req=True)
        >>> result = thread.get()
